...
//////////////////////////////////////////////////////////////////////////////////////////////
        ...
        int techniqueIndex) const
    {
        ...
        auto captureMarker = _pimpl->_charactersSharedStateSet.CaptureState(context, parserContext.GetRenderStateDelegate(), parserContext.GetRenderStateDelegateParameters());
