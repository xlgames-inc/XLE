...
print "PreprocessXAML: CL.exe /nologo /EP /D$definedConstant $unprocessedFile > $comparisonFile\n";
$message = `CL.exe /nologo /EP /D$definedConstant $unprocessedFile > $comparisonFile`;
