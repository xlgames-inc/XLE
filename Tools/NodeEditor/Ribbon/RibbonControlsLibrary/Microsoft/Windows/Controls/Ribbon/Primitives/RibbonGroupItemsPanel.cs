//---------------------------------------------------------------------------
// <copyright file="RibbonGroupItemsPanel.cs" company="Microsoft Corporation">
...
namespace Microsoft.Windows.Controls.Ribbon.Primitives
{
    ...
    public class RibbonGroupItemsPanel : Panel, IProvideStarLayoutInfo, IContainsStarLayoutManager
    {
        ...
        /// <summary>
        ///   Initializes static members of the RibbonGroupItemsPanel class.
        /// </summary>
        static RibbonGroupItemsPanel()
        {
        }
