//---------------------------------------------------------------------------
// <copyright file="RibbonMenuButton.cs" company="Microsoft Corporation">
...
namespace Microsoft.Windows.Controls.Ribbon
{
    ...
    public class RibbonMenuButton : Menu
    {
        ...
        internal static readonly RoutedEvent IsSelectedChangedEvent = EventManager.RegisterRoutedEvent(
                                                                    "IsSelectedChanged", RoutingStrategy.Bubble, typeof(RoutedPropertyChangedEventHandler<bool>), typeof(RibbonMenuButton));
        ...
        /// </summary>
        /// <value></value>
        internal FrameworkElement CurrentSelection
        {
            get
            {
        ...
        private FrameworkElement _currentSelection;     // could be a RibbonMenuItem or RibbonGallery
