...
namespace Microsoft.Windows.Controls.Ribbon
{
    ...
    internal static class NativeMethods
    {
        ...
        // The Next three imports are used for the menu on the caption bar
        [DllImport("user32.dll")]
        ...
        {
            return (int)LOWORD(lParam.ToInt32());
        }

        public static int GET_Y_LPARAM(IntPtr lParam)
        {
            return (int)HIWORD(lParam.ToInt32());
        }

        public static Int16 LOWORD(int i)
        {
            return (Int16)(i & 0xFFFF);
        }

        public static Int16 HIWORD(int i)
        {
            return (Int16)(i >> 16);
        }
