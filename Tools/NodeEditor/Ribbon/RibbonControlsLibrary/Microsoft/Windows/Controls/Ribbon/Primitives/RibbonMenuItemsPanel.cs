//---------------------------------------------------------------------------
// <copyright file="RibbonMenuItemsPanel.cs" company="Microsoft Corporation">
...
namespace Microsoft.Windows.Controls.Ribbon.Primitives
{
    ...
    public class RibbonMenuItemsPanel : VirtualizingStackPanel, ISupportStarLayout
    {
        ...
        bool _isStarLayout;
        WeakHashSet<IProvideStarLayoutInfoBase> _registeredStarLayoutProviders = new WeakHashSet<IProvideStarLayoutInfoBase>();
        internal Size _cachedAutoSize = new Size();
    }
}
