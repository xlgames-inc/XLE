//---------------------------------------------------------------------------
// <copyright file="RibbonMenuItem.cs" company="Microsoft Corporation">
...
namespace Microsoft.Windows.Controls.Ribbon
{
    ...
    public class RibbonMenuItem : MenuItem, ISyncKeyTipAndContent
    {
        ...
        static RibbonMenuItem()
        {
            ...
            EventManager.RegisterClassHandler(ownerType, RibbonMenuButton.IsSelectedChangedEvent, new RoutedPropertyChangedEventHandler<bool>(OnIsSelectedChanged));
        ...
        protected override DependencyObject GetContainerForItemOverride()
        {
            ...
            if (UsesItemContainerTemplate)
            {
                ...
                if (itemContainerTemplate != null)
                {
                    ...
                    {
                        throw new InvalidOperationException(SR.Get(SRID.InvalidMenuButtonOrItemContainer, this.GetType().Name, itemContainer));
                    }
                }
            }
        ...
        protected override void OnMouseLeftButtonUp(MouseButtonEventArgs e)
        {
            ...
            {
                // For TopLevelItems, base closes the submenu on mouse up by exiting MenuMode.
                // We dont want to allow this if StaysOpen is true. Hence do the needed and handle the event.
                UpdateIsPressed();
                e.Handled = true;
            }
        ...
        void OnPopupResizeStarted(object sender, DragStartedEventArgs e)
        {
            ...
            if (CurrentSelection != null)
            {
                RibbonMenuItem selectedMenuItem = CurrentSelection as RibbonMenuItem;
        ...
        private void OpenSubmenuWithKeyboard()
        {
            OpenSubmenu();
            // Select first Item. 
        ...
        private static void OnIsSubmenuOpenChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            if ((bool)e.OldValue)
            {
                // If the submenu is closed due to
        ...
        private FrameworkElement CurrentSibling
        {
            get
            {
                ...
                else
                {
                    ...
                    {
                        sibling = menuButtonParent.CurrentSelection;
                    }
                }
        ...
        /// </summary>
        internal static readonly DependencyProperty IsSelectedProperty = DependencyProperty.Register("IsSelected",
                                                                                                    typeof(bool),
                                                                                                    typeof(RibbonMenuItem),
                                                                                                    new FrameworkPropertyMetadata(false,
        ...
        private static void OnIsSelectedChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            menuItem.RaiseEvent(new RoutedPropertyChangedEventArgs<bool>((bool)e.OldValue, (bool)e.NewValue, RibbonMenuButton.IsSelectedChangedEvent));
        }
            ...
            if (sender != e.OriginalSource)
            {
                ...
                if (e.NewValue)
                {
                    if (selectionItem != null)
                    {
                        ...
                        {
                            menuItem.CurrentSelection = selectionItem;
                        }
                    }
                }
                else
                {
                    ...
                    if (menuItem.CurrentSelection == selectionItem)
                    {
                        menuItem.CurrentSelection = null;
                    }
                }
        ...
        ///     of this MenuItem.
        /// </summary>
        private FrameworkElement CurrentSelection
        {
            get
            {
            ...
            set
            {
                ...
                {
                    RibbonMenuItem selectedMenuItem = _currentSelection as RibbonMenuItem;
                    if (selectedMenuItem != null)
                    {
                    ...
                    {
                        RibbonGallery selectedGallery = _currentSelection as RibbonGallery;
                        if (selectedGallery != null)
                        {
                            selectedGallery.IsSelected = false;
                        }
                    }

                    _currentSelection = value;

                    selectedMenuItem = _currentSelection as RibbonMenuItem;
                    if (selectedMenuItem != null)
                    {
                    ...
                    else
                    {
                        ...
                        if (selectedGallery != null)
                        {
                            selectedGallery.IsSelected = true;
                        }
                    }
                }
            }
        ...
        private FrameworkElement _currentSelection; // can be a RibbonMenuItem or RibbonGallery
        Rect _screenBounds;
