//---------------------------------------------------------------------------
// <copyright file="RibbonHelper.cs" company="Microsoft Corporation">
...
namespace Microsoft.Windows.Controls.Ribbon
{
    ...
    internal static class RibbonHelper
    {
        ...
        {
            if (SystemParameters2.Current.HighContrast || !popup.IsOpen)
            {
                popup.PopupAnimation = PopupAnimation.None;
            }
            else
        ...
        private static FrameworkElement CreateInstance(FrameworkElement original, bool allowTransformations)
        {
            ...
            bool isMenuItem = (menuItem != null);
            bool isSplitMenuItem = isMenuItem && original is RibbonSplitMenuItem;
