//---------------------------------------------------------------------------
// <copyright file="RibbonControlLength.cs" company="Microsoft Corporation">
...
namespace Microsoft.Windows.Controls.Ribbon
{
    ...
    public struct RibbonControlLength : IEquatable<RibbonControlLength>
    {
        ...
        public RibbonControlLength(double value, RibbonControlLengthUnitType type)
        {
            ...
            {
                throw new ArgumentException(SR.Get(SRID.InvalidCtorParameterNoInfinityForStarSize, "value"));
            }
            ...
            {
                throw new ArgumentException(SR.Get(SRID.InvalidCtorParameterUnknownRibbonControlLengthUnitType, "type"));
            }
