...
//    wpfoob\common\Microsoft\Windows\Controls\TreeHelper.cs
// ---------------------------------------------------------------------------
//------------------------------------------------------------------------------
// <copyright file="TreeHelper.cs" company="Microsoft Corporation">
...
namespace Microsoft.Windows.Controls
{
    ...
    internal static class TreeHelper
    {
        ...
        /// <summary>
        ///     Walks up the logical tree and finds the element
        ///     which has no logical parent.
        /// </summary>
        public static DependencyObject FindLogicalRoot(DependencyObject element)
        {
            while (element != null)
            {
