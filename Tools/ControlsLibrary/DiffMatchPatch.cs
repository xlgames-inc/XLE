...
//  DAVIDJ --------------
//              NOTE
//      I have made small changes to remove a dependency on HttpUtility 
//      (this class requires an extra dll dependency)
//      Html output may not work perfectly in this version of the file!
//
    ...
    public override string ToString() {
      ...
      foreach (Diff aDiff in this.diffs) {
        ...
        text.Append(/*HttpUtility.UrlEncode(aDiff.text,
            new UTF8Encoding())*/aDiff.text.Replace('+', ' ')).Append("\n");
      }
