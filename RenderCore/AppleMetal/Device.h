...
////////////////////////////////////////////////////////////////////////////////
    ...
    public:
        ...
        id<MTLDevice> GetUnderlying() const { return (id<MTLDevice>)_underlying.get(); }
    ...
    protected:
        IdPtr _underlying;                 // id<MTLDevice>
...
namespace RenderCore
{
    ...
    // RenderCore's CreateDevice), or it will have no effect.
    //
