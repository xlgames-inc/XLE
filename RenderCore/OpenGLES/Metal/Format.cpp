...
#pragma clang diagnostic ignored "-Wswitch" // (enumeration values not used)
    ...
    glPixelFormat AsTexelFormatType(RenderCore::Format fmt)
    {
        ...
        case Format::B5G5R5A1_UNORM: return {GL_RGBA, GL_UNSIGNED_SHORT_5_5_5_1, GL_RGBA, FeatureSet::GLES200, FeatureSet::GLES200};
        case Format::R4G4B4A4_UNORM: return {GL_RGBA, GL_UNSIGNED_SHORT_4_4_4_4, GL_RGBA, FeatureSet::GLES200, FeatureSet::GLES200};
#endif
