...
namespace RenderCore { namespace Metal_DX11
{
    ...
    {
        if (!resource) {
            ThrowException(Exceptions::GenericFailure("NULL resource passed to RenderTargetView constructor"));
        }
    ...
    {
        if (!resource) {
            ThrowException(Exceptions::GenericFailure("NULL resource passed to DepthStencilView constructor"));
        }
    ...
    {
        if (!resource) {
            ThrowException(Exceptions::GenericFailure("NULL resource passed to UnorderedAccessView constructor"));
        }
