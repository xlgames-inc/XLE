...
namespace RenderingInterop
{
    ...
    public class Crc32
    {
        ...
        public static uint GetHash(string s)
        {
            ...
            System.UInt32 hash = 0xffffffff;
            foreach (char c in s)
            {
                System.Byte b = (System.Byte)c;
        ...
        private static HashSet<uint> s_hashes = new HashSet<uint>();
        // Normal form Polynominal = 0x04c11db7 (CRC-32-MPEG2 / CRC-32-IEEE 802.3)
        // Byte Size               = 4 * 256 = 1024
        private static UInt32[] g_fgCrcTable32 = new UInt32[]
        {
