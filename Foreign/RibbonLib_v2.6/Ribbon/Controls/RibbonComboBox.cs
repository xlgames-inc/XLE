...
//
//  Contents:   Helper class that wraps a ribbon combobox control.
//
//*****************************************************************************
...
namespace RibbonLib.Controls
{
        ...
        IPreviewEventsProvider
    {
        ...
        private StringValuePropertiesProvider _stringValuePropertiesProvider;
        ...
        public string StringValue
        {
            get
            {
                return _stringValuePropertiesProvider.StringValue;
            }
            set
            {
                _stringValuePropertiesProvider.StringValue = value;
            }
        }
