...
//      DavidJ -- NOTE -- 
//              The class "DateUtils" has been modified for inclusion in XLE!
//              See further notes below.
//      Functionality is unchanged. But some behaviour has been moved out-of-line.
...
//      DavidJ -- NOTE -- modification here to prevent inclusion of windows.h!
#   include <direct.h>
// #   include <Windows.h>
#endif // _ELPP_OS_UNIX
#include <string>
...
//      DavidJ -- NOTE -- 
//              The class "DateUtils" has been modified for inclusion in XLE!
//              The functionality is still the same. But some parts have been moved 
//              out-of-line so that we can avoid #include <windows.h> in many cases.
//
...
public:
...
#if _ELPP_OS_WINDOWS
    static void gettimeofday(struct TimeType *tv);
#endif // _ELPP_OS_WINDOWS
    ...
    static double getTimeDifference(const TimeType& endTime_, const TimeType& startTime_);
}; // class DateUtils
} // namespace utilities
...
public:
    RegisteredLoggers(void) :
        ...
        defaultConfigurations_.setToDefault();
            ...
            //  DavidJ -- NOTE -- modification here!
            //      required explicit initialisation from client code, so
            //      that the defaults aren't always there. This would create
            //      a log file in the default place every time, even if we
            //      didn't need it.
        // Configurations conf;
        // conf.setToDefault();
...
#   define FUNC_SUB_COMMON_START { easyloggingpp::internal::utilities::DateUtils::TimeType functionStartTime, functionEndTime; _ELPP_GET_CURR_TIME(&functionStartTime)
