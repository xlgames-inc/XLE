...
//      DavidJ -- NOTE -- 
//              The class "DateTime" has been modified for inclusion in XLE!
//              See further notes below.
//      Functionality is unchanged. But some behaviour has been moved out-of-line.
//
//      There are also other minor changes to remove dependencies on windows.h and winsock.h
...
#   include <direct.h>
//      DavidJ -- I made modification here to remove dependencies on windows header
// #   include <windows.h>
...
public:
    ...
    static base::type::fstream_t* newFileStream(const std::string& filename) {
        base::type::fstream_t *fs = new base::type::fstream_t(filename.c_str(), 
                // DavidJ -- modication here to truncate, rather than append, when opening this file
