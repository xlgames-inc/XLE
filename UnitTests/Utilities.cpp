...
namespace UnitTests
{
    ...
    public:
        TEST_METHOD(ParameterBoxTest)
        {
            ...
            Assert::AreEqual(test.GetParameter<unsigned>(MakeStringSection((const utf8*)"SomeParam")).value(), 1u, L"String parsing and constructor");
            Assert::AreEqual(test.GetParameter<float>(MakeStringSection((const utf8*)"SomeParam1")).value(), .4f, L"String parsing and constructor");
            Assert::AreEqual(test.GetParameter<float>(MakeStringSection((const utf8*)"SomeParam2")).value(), 344.f, 0.001f, L"String parsing and constructor");
            Assert::AreEqual(test.GetParameter<float>(MakeStringSection((const utf8*)"SomeParam3")).value(), .56f, 0.001f, L"String parsing and constructor");
            ...
            Assert::AreEqual(test.GetParameter<float>(MakeStringSection((const utf8*)"AParam")).value(), 500.f, 0.001f, L"Changing parameter types");

            test.SetParameter((const utf8*)"ShouldBeTrue", true);
            Assert::AreEqual(test.GetParameter<bool>(MakeStringSection((const utf8*)"ShouldBeTrue")).value(), true, L"Store/retrieve boolean");
