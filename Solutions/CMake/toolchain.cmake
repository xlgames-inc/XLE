...
set(XLE_CUSTOM_CMAKE_CFG NO CACHE BOOL "Draw compiler settings from the .props files rather than cmake configuration settings")

# We used to disable as much of the cmake logic for compiler and linker flags as possible, and instead
# just include in .props files (used by the Microsoft build system) for configuring the compiler flags
# This only works when using the Microsoft toolchain, however, since those props files are specific to
# that build system.
if (XLE_CUSTOM_CMAKE_CFG)
